...
export default function Footer() {
  return (
    <footer className="py-6 sm:py-8 px-4 sm:px-6 border-t-10 border-white" style={{ backgroundColor: "#d80032" }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-start justify-between gap-6 md:gap-0">
          <div className="flex-1 w-full md:w-auto text-center md:text-left">
            <h2 className="text-xl sm:text-2xl font-black text-white mb-2 tracking-wider">
              POKÉDEX<br />ONLINE
            </h2>
          ...
          <div className="flex-1 w-full md:w-auto text-center md:text-right">
            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">Connect with Me!</h3>
            ...
            <div className="flex items-center justify-center md:justify-end gap-3 sm:gap-4">
              ...
              <a href="https://github.com/AlyssaArgoncillo" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-300 hover:text-red transition">
                <svg viewBox="0 0 24 24" width="36" height="36" className="sm:w-10 sm:h-10" fill="white" aria-hidden="true">
              ...
              <div className="relative group">
                <button className="text-white-800 hover:text-gray-800 transition" aria-label="Discord">
                  <svg viewBox="0 0 24 24" width="40" height="40" className="sm:w-11 sm:h-11" fill="white" aria-hidden="true">
